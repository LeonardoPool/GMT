    ...
    <div class="content-wrapper" style="padding-bottom: 0;">
        ...
        <div class="nav-container" style="background: white; border-bottom: 1px solid #f0f0f0;">
            ...
            <div class="nav-links">
                ...
                >
                    <button type="button" class="nav-link-btn" style="color: #1a1a1a;" onclick={(e) => { e.stopPropagation(); openDropdown('login'); }}>
                        Iniciar Sesión
                ...
                <div
                    ...
                    onfocusout={scheduleCloseDropdown}
                >
                    <button type="button" class="nav-link-btn" style="color: #1a1a1a;" onclick={(e) => { e.stopPropagation(); openDropdown('register'); }}>
                        Solicitar Acceso
                        <span class="dropdown-arrow">▾</span>
                    </button>
                    <div
